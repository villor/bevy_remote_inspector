//! Copied with some adjustment from https://github.com/bevyengine/bevy/blob/main/examples/games/breakout.rs
...
fn main() {
    App::new()
        ...
        .init_resource::<HideBricksOnCollision>()
        .run();
}
...
struct HideBricksOnCollision(bool);
...
fn check_for_collisions(
    ...
    hide_brick: Res<HideBricksOnCollision>,
) {
